...
public class ProgressView extends View {
    ...
    private void initArrt(Context context, AttributeSet attrs, int defStyle) {
        ...
        mColor = (int) a.getColor(
                R.styleable.ProgressView_p_color, Color.parseColor("#FF78909C"));// 音量条的宽度
        mTitleRadio = (int) a.getDimension(
                R.styleable.ProgressView_titleradio, mTitleRadio);// 音量条之间的距离

        mTitleColor = (int) a.getColor(
                R.styleable.ProgressView_titlecolor, Color.parseColor("#FF78909C"));// 背景音乐条的高度
        a.recycle();
    }
